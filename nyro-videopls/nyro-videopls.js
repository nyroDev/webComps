...
window.NyroVideopls = class extends HTMLElement {
    connectedCallback() {
        ...
        this.addEventListener("nyroVideoControlsInited", (e) => {
            const htmls = [document.createElement("div"), document.createElement("div")];
            ...
            const after = e.detail.dom.controls.querySelector(
                e.detail.controls.indexOf("playPause") > -1 ? ".nyroVideoPlayPause" : ".nyroVideoProgress"
            );
    ...
    addItem(item) {
        ...
        if (this._items.length === 1) {
            if (this._autoplay) {
                ...
                this.dispatchEvent(
                    new CustomEvent("nyroVideoPlsActiveItem", {
                        bubbles: true,
                        cancelable: true,
                        detail: item,
                    })
